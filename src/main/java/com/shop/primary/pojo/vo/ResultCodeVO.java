...
public class ResultCodeVO {
    ...
    public final static ResultCodeVO UN_LOGIN_CODE = new ResultCodeVO("401", "你的登录信息已过期，请重新登录");
    ...
    public final static ResultCodeVO PARAM_ERR = new ResultCodeVO("400", "参数错误");
