				...
				<div class="ibox-content">
					<form role="form" id="addForm" class="form-horizontal m-t">
						<div class="form-group draggable">
							...
							<div class="col-sm-2">
								<input type="text" name="permissionName" value="${permission.permissionName}" class="form-control"required>
						...
						<div class="form-group draggable">
							...
							<div class="col-sm-2">
								<input type="text" name="permissionSign" value="${permission.permissionSign}" class="form-control"required>
							</div>
						</div>
						<input name="version" type="hidden" value="${permission.version}"/>
						<div class="form-group draggable">
							<label class="col-sm-3 control-label">权限描述：</label>
							<div class="col-sm-2">
								<input type="text" name="permissionDescription" value="${permission.description}" class="form-control">
							</div>
						</div>
...
<script>
    function add(){
        $.ajax({
            type: 'POST',
            url: '<%=path %>/rest/permission/saveOrUpdatePermission',
