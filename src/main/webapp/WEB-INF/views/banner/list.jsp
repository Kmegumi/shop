            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="form-group">
                        <form  action="<%=path%>/rest/banner/list" id="formPage" method="post">
                            <input type="hidden" name="pageNo" id="pageNo" value="${form.pageNo}"/>
                            名称：<input type="text" name="name" value="${form.name}" >
                <span style="float: right;">
                   <a class="btn btn-primary J_menuItem" type="button" href="<%=path%>/rest/banner/add" >添加</a>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <c:forEach items="${page.content}" var="demo">
                            <tr>
                                ...
                                <td class="center">${demo.url}</td>
                                <td class="col-sm-2">
                                    <a class="btn btn-primary J_menuItem" type="button" href="<%=path%>/rest/banner/add?id=${demo.id}" >编辑</a>
