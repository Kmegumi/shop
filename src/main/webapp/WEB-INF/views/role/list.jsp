            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="form-group">
                        <form  action="<%=path%>/rest/role/list" id="formPage" method="post">
                            <input type="hidden" name="pageNo" id="pageNo" value="${form.pageNo}"/>
                            名称：<input type="text" name="name" value="${form.name}" >
                <span style="float: right;">
                   <a class="btn btn-primary J_menuItem" type="button" href="<%=path%>/rest/role/add" >添加</a>
                        ...
                        <c:if test="${dome != null}">
                            <c:forEach items="${dome.list}" var="var">
                                <tr>
                                    ...
                                    <td class="center">${var.roleSign}</td>
                                    <td class="center">${var.description}</td>
                                    <td class="col-sm-2">
                                        <a class="btn btn-primary J_menuItem" type="button" href="<%=path%>/rest/role/edit/${var.id}" >编辑</a>
