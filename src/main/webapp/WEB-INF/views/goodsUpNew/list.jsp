            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="form-group">
                        <form  action="<%=path%>/rest/goodsUpNew/list" id="formPage" method="post">
                            <input type="hidden" name="pageNo" id="pageNo" value="${form.pageNo}"/>
                            名称：<input type="text" name="name" value="${form.name}" >
                <span style="float: right;">
                   <a class="btn btn-primary J_menuItem" type="button" href="<%=path%>/rest/goodsUpNew/add" >添加</a>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <c:forEach items="${page.content}" var="demo">
                            <tr>
                                ...
                                <td class="col-sm-2">
                                    <a class="btn btn-primary J_menuItem" type="button" href="<%=path%>/rest/goodsUpNew/add?id=${demo.id}" >编辑</a>
...
<script>
    function del(id){
        swal({
            ...
            $.ajax({
                type: 'POST',
                url: '<%=path %>/rest/goodsUpNew/delete',
                data: {id:id},
                cache: false,
                dataType: "json",
                async: true,
                    ...
                    if (data) {
                        if (data.code == '200') {
                            ...
                            $('.confirm').click(function () {
                                window.location.href="<%=path%>/rest/goodsUpNew/list";
                            });
                        } else {
