...
<div class="page-group">
  <div class="page page-current" id='router'>
    ...
    <div class="content">
      <input id="id" type="hidden" value="${afterSale.id}">
      <input id="afterSaleReasonsName" type="hidden" value="${afterSaleReasonsName}">
      <input id="orderId" type="hidden" value="${afterSale.order.id}">
      <div class="order-detail" style="margin-bottom: 0.4rem;">
        ...
        <div class="order-detailRight">
          ...
          <div class="detailRight_f2">实付金额：<em>￥${afterSale.order.orderMoney}</em></div>
        </div>
      </div>
      <div class="service-row">
        <div class="service-title">申请售后原因</div>
        <div class="service-content">
          <input type="text" id='picker' value="${afterSale.afterSaleReasons.name}" placeholder="选择原因"/>
        </div>
      </div>
      <div class="service-row">
      ...
      <div class="service-row">
        ...
        <div class="service-content2">
          <textarea name="" id="describe" cols="30" rows="10" placeholder="请详细描述问题">${afterSale.describe}</textarea>
        </div>
...
<script>
  ...
  var goodsNum = '${afterSale.order.goodsNum}';
  var numArr = [];
  ...
  function saveAfterSale() {
    ...
    $j.ajax({
      ...
      data: {id:id, orderId:orderId, afterSaleReasonsName:afterSaleReasons, describe:describe, afterSaleNum:afterSaleNum},
      cache: false,
      dataType: "json",
      async: true,
