...
<div class="page-group">
  <div class="page page-current" id='router'>
    ...
    <div class="content">
      <form>
        <div class="addAddress-row"><input type="hidden" id="addressId" value=""><input type="text" id="addressName" placeholder="姓名"></div>
        <div class="addAddress-row"><input type="tel" id="addressTel" placeholder="手机号码"></div>
        <div class="addAddress-row"><input type="text" id="city-picker" value="" placeholder="省份、城市、区县"/></div>
        <div class="addAddress-row"><input type="text" id="addressDetail" placeholder="详细地址（如街道、楼盘号等）"></div>
        <div class="default" id="default"  data-type="no">
          ...
          <div class="default-font">设为默认地址</div>
        </div>
...
<script>
  ...
  function saveAddress() {
    ...
    $.ajax({
      ...
      data: {name:addressName, tel:addressTel, city:city, detail:addressDetail, defaultFlag:flag},
      cache: false,
      dataType: "json",
      async: true,
